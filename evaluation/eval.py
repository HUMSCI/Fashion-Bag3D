...
def main_mul_cat_detail_10run():
    ...
    parser.add_argument('--out_xlsx', type=str, default='results_100/kiss3dgen.xlsx', help='Output Excel file.')
    ...
    for cat in FARFETCH_CATEGORIES:
        ...
        elif args.method == 'Ours_1024': ##Ablation study Ours_front, Ours_front_prompt,Ours_front_back
            gen_root = os.path.join(args.gen_root_base, cat)
